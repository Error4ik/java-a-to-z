...
public class Add extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        final Role role = roleDao.getRoleByName(req.getParameter("role"));
        final Country country = countryDao.getCountryByName(req.getParameter("country"));
        final City city = cityDao.getCityByName(req.getParameter("city"));
        this.userDao.addUser(new User(0, login, pass, email, new Date(), role, country, city));
