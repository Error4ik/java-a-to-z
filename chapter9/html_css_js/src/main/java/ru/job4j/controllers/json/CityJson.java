...
public class CityJson extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Country country = countryDao.getCountryByName(req.getParameter("country"));
        List<City> countries = cityDao.getAllCityByCountry(country.getId());
    ...
    public void init() throws ServletException {
        ...
        this.cityDao = new CityToDB(PoolDataSource.setupDataSource(
